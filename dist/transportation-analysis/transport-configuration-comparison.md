...
| **Driver gap** (vs. 17-20 available) | **-10 to -13** | **-4 to -7** | **-9 to -12** |
| **Bus tiers required** | 3-4 | 3 | 3-4 |
| **MV exposure (annual)** | $54,337-$127,853 | $30,365-$79,908 | $46,347-$111,871 |
| **Route expansion cost (annual)** | $748,472 | $0 | $623,726 |
| **Care gap families** | 42-144 | 0 | 37-128 |
| **District cost (annual)** | $802,809-$876,325 | $30,365-$79,908 | $670,073-$735,597 |
| **Family cost (annual, care gaps)** | $143,640-$803,520 | $0 | $126,540-$714,240 |
| **Total fiscal exposure** | **$946,449-$1,679,845** | **$30,365-$79,908** | **$796,613-$1,449,837** |
| **As % of claimed $1.5-2.2M savings** | **43-112%** | **1.4-5.3%** | **36-97%** |
...
|------|----------|-------------|
| SPEC-060 | Split-Family Count | Enrollment (school-geography trove), Census SIPP sibling rates |
| SPEC-061 | McKinney-Vento | MV eligibility rate (evidence pools), transport costs (DOE data) |
| SPEC-062 | SEA Staffing | Driver count (3/30 BoE meeting), SEA FTE (budget documents) |
| SPEC-063 | Bell Schedule | [SPSD website](https://www.spsd.org/families/school-start-dismissal-times), driver schedule (3/30 BoE meeting) |
| SPEC-064 | Care Gap | [SoPo Kids Club rates](https://southportlandme.myrec.com/info/activities/program_details.aspx?ProgramID=31539), split-family + bell schedule outputs |
| SPEC-065 | Configuration Comparison | DOE per-pupil FY23-FY25, all upstream spec outputs |

All calculation scripts: `pipeline/transport/`
Machine-readable comparison: `data/transport-comparison.json`
