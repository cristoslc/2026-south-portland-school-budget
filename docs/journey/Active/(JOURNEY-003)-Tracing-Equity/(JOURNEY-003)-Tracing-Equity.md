---
title: "Tracing Equity Through the Budget"
...
journey
    ...
    section Framing the Question
      Review district equity commitments: 4: Equity Advocate
      Define accountability criteria: 4: Equity Advocate
    section Seeking Disaggregated Data
      Look for per-school spending data: 1: Equity Advocate
      Find staffing cut impact by population: 1: Equity Advocate
      Cross-reference with state DOE demographics: 3: Equity Advocate
    section Evaluating Reconfiguration Equity
      Find Dyer demographic profile: 2: Equity Advocate
      Assess redistricting equity impact: 1: Equity Advocate
      Evaluate Skillin protection rationale: 3: Equity Advocate
    section Tracing Federal Funding
      Find Title I allocation by school: 1: Equity Advocate
      Review audit grant misallocation: 2: Equity Advocate
      Assess SPED staffing adequacy: 1: Equity Advocate
    section Building the Advocacy Case
      Assemble findings across sources: 2: Equity Advocate
      Draft testimony or op-ed: 4: Equity Advocate
    section Monitoring Outcomes
      Track equity commitments post-adoption: 2: Equity Advocate
```
