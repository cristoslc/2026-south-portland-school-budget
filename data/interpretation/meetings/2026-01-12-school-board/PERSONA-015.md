---
schema_version: "1.0"
meeting_id: "2026-01-12-school-board"
persona_id: "PERSONA-015"
persona_name: "Sheanna"
meeting_date: 2026-01-12
meeting_title: "School Board Regular Meeting -- January 12, 2026"
...
- **Threat level:** 2
- **Open question:** true — Sheanna heard the union name what she already knows: the training can't stop at the classroom door. But the board didn't respond directly to whether the protocol will be extended to transportation and facilities staff.
...
- **Emotional valence:** positive
- **Threat level:** 2
- **Open question:** true — Sheanna would want to be sure that the spending freeze impact report captures what's happening in intervention and specialist services specifically — not just what principals observe in their own buildings, but what staff traveling between buildings are seeing across the system.
...
```mermaid
journey
    title Sheanna's journey: Budget fear meets ICE fear
    section Professional signals, routine updates
        MTSS data mentioned in student rep report: 3: Sheanna
        ESOL adults on wait list — familiar pattern: 2: Sheanna
    section Immigration crisis hits close to home
        Children absent from school due to ICE fear: 2: Sheanna
        Unions speak — service staff named, solidarity: 4: Sheanna
    section The budget numbers land
        Finance report — deficit likely, red ahead: 1: Sheanna
        Retirements not backfilled — 16 ed tech cuts loom: 1: Sheanna
    section Small validation, unresolved dread
        Smith asks about spending freeze on staff: 3: Sheanna
```
