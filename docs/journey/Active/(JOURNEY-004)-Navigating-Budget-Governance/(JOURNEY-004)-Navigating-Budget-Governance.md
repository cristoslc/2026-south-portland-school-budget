...
journey
    title Navigating the Budget as a Governance Participant
    section Receiving the Proposal
      Review superintendent's presentation: 4: Governance Participant
      Assess alignment with board guidance: 3: Governance Participant
      Get union briefing on staffing cuts: 3: Frontline Educator
    section Interrogating the Detail
      Request line-item budget book: 2: Governance Participant
      Ask for scenario modeling: 3: Governance Participant
      Find building-level staffing breakdown: 1: Frontline Educator
    section Balancing Stakeholders
      Hear parent testimony: 3: Governance Participant
      Hear teacher/union testimony: 3: Governance Participant
      Assess silent middle: 2: Governance Participant
    section Navigating Council
      Present budget to council: 3: Governance Participant
      Respond to councilor guidance range: 2: Governance Participant
    section Building Consensus
      Negotiate with other board members: 3: Governance Participant
      Resolve reconfiguration disagreements: 2: Governance Participant
    section Communicating the Decision
      Frame narrative for multiple audiences: 2: Governance Participant
      Reach residents outside meetings: 1: Governance Participant
    section Surviving the Referendum
      Campaign for budget validation: 3: Governance Participant
      Manage combined-budget referendum risk: 2: Governance Participant
```
